...
with open(f"results/explainable_results_w{args.weight}.json", "w") as f:
    json.dump({
        "model": f"explainable_w{args.weight}",
        "consistency_weight": args.weight,
        "episodes": results,
        "averages": {
...
print(f"Results saved to results/explainable_results_w{args.weight}.json")
